...
export class ForestCard extends PermanentCard {
    constructor() {
        super('Forest', ['Land', 'Basic', 'Forest'], '{A1}{T}{EC1}Add {G}.{EA1}', undefined, new SimpleActivatedAbility(new TapCost(), card => new AddManaEffect({ generic: 1, colorless: 1, green: 3 }).resolve(card)));
    }
...
export class LlanowarElvesCard extends CreatureCard {
    constructor() {
        ...
        new ManaCost({ choices: [[{ green: 1 }, { white: 1 }, { red: 1 }], [{ generic: 1 }, { generic: 2 }, { generic: 6, blue: 3 }, { green: 2 }]] }), new SimpleActivatedAbility(new TapCost(), card => new AddManaEffect({ green: 1 }).resolve(card)));
    }
...
class FigureOfDestinyCard extends CreatureCard {
    constructor() {
        ...
        {R/W}{R/W}{R/W}{R/W}{R/W}{R/W}: If {CARDNAME} is a Warrior, it becomes a 8/8 Kithkin Spirit Warrior Avatar with flying and first strike.`, 1, 1, new ManaCost({ choices: [[{ red: 1 }, { white: 1 }]] }), [] // TODO
        );
    }
